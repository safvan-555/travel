          ...
          <div class="col-xxl-8 col-lg-7">
            <div class="tour-page-single">
              <div class="slider-area tour-slider1">
                ...
                <div
                  class="swiper th-slider tour-thumb-slider"
              ...
              <div class="page-content">
                ...
                <h4 class="tour-price">
                  <span class="currency">$189,25</span>/Person
                </h4>
                ...
                <div class="offer-banner">
                  <div class="offer">
                    ...
                    <div class="offer">
                      ...
                      <a class="offter-num" href="%2b256214203215.html"
                        >+256 214 203 215</a
                      >
                    </div>
                    <a href="contact.php" class="th-btn style2 th-icon"
                      >Read More</a
                    >
                  </div>
                </div>
